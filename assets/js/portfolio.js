var port = {
    ...
    items: [
      { title: "All Things {Front-End}", img: "assets/dist/images/sm/all-things-front-end-sm.jpg", desc: "'All Things {Front-End}' is an article scraper where users can add notes and save articles. Created with Node.js, MongoDB, Express, Handlebars, SCSS, BEM, Gulp, Cheerio, and Axios.", tags: ["MongoDB", "Node", "Sass", "Express", "Sass", "UI/UX", "Mobile-First"], url: "https://all-things-fe.herokuapp.com/", repo: "https://github.com/acarlie/all_things_front-end" },
