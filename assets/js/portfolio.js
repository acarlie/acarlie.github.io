var port = {
    ...
    items: [
      ...
      { title: "Color Me ____.", img: "assets/dist/images/sm/color-me-4-sm.jpg", desc: "'Color Me ___' is a word guessing game created with Vanilla JS.", tags: ["Vanilla JS", "UI/UX"], url: "https://acarlie.github.io/Word_Guess_Game/", repo: "https://github.com/acarlie/Word_Guess_Game" },
      { title: "Giphy Search", img: "assets/dist/images/sm/giphy-2-sm.jpg", desc: "'Giphy Search' was created using Giphy's API. Users can favorite gifs and copy gif embed links. Designed mobile first.", tags: ["jQuery, JavaScript, AJAX"], url: "https://acarlie.github.io/Giphy_Project/", repo: "https://github.com/acarlie/Giphy_Project" },
      ...
      { title: "Train Scheduler", img: "assets/dist/images/sm/train-schedule-sm.jpg", desc: "Train scheduling app created using jQuery, Firebase, and Materialize.", tags: ["jQuery, Firebase, Materialize"], url: "https://acarlie.github.io/Train_Scheduler/", repo: "https://github.com/acarlie/Train_Scheduler" },
      ...
      { title: "Women of Scifi and Fantasy Trivia", img: "assets/dist/images/sm/trivia-game-sm.jpg", desc: "Timed trivia game created with jQuery and JavaScript.", tags: ["jQuery, JavaScript"], url: "https://acarlie.github.io/Trivia_Game/", repo: "https://github.com/acarlie/Trivia_Game" },
      { title: "A Stranger Game", img: "assets/dist/images/sm/a-stranger-game-2-sm.jpg", desc: "Player vs algorithm game created using jQuery and JavaScript.", tags: ["jQuery"], url: "https://acarlie.github.io/Stranger_Things_Game/", repo: "https://github.com/acarlie/Stranger_Things_Game" },
