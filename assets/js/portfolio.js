var port = {
    ...
    items: [
      ...
      { title: "Giphy Search", img: "assets/images/portfolio/giphy-2.JPG", desc: "'Giphy Search' was created using Giphy's API. Users can favorite gifs and copy gif embed links.", tags: ["jQuery, JavaScript, AJAX"], url: "https://acarlie.github.io/Giphy_Project/", repo: "https://github.com/acarlie/Giphy_Project" },
      { title: "Movie Comparison App", img: "assets/images/portfolio/movie-comp.JPG", desc: "Movie comparison app created with AJAX, jQuery, Chart.js, and Materialize.", tags: ["jQuery, JavaScript, UI/UX, Materialize, AJAX"], url: "https://fzachary.github.io/project1/", repo: "https://github.com/fzachary/project1" },
      { title: "Liri Node App", img: "assets/images/portfolio/liri_spotify-this.png", desc: "Node.js App for searching OMDB, Spotify, and Bands in Town. Created with ES6.", tags: ["ES6, Node.JS"], url: "", repo: "https://github.com/acarlie/liri_node_app" },
      ...
      { title: "Wags with Friends", img: "assets/images/portfolio/wags-with-friends.JPG", desc: "App for finding playmates for pets. Created with SASS, MySQL, Sequelize, Node.js, Express, Express-Handlebars.", tags: ["MySQL, Sequelize, SASS"], url: "https://project2-10-2019.herokuapp.com/", repo: "https://github.com/austdobe/project2" },
      ...
      { title: "Wikipedia Search", img: "assets/images/portfolio/wikipedia-viewer.JPG", desc: "Wikipedia search using Vanilla JS and Wikipedia's API", tags: ["Vanilla JS", "Rest APIs", "UI/UX", "SCSS", "Bootstrap"], url: "https://codepen.io/acarlie/full/mERLej", repo: "" },
      { title: "Vanilla JS Typewriter", img: "assets/images/portfolio/typewriter.JPG", desc: "Vanilla JS typerwiter created using setInterval, clearInterval, and setTimeout", tags: ["Vanilla JS"], url: "https://codepen.io/acarlie/full/KOqmPN", repo: "" }
    ],
    generate: function() {
